...
/**
 * @extends ServiceEntityRepository<JobInstance>
 *
 * @method JobInstance|null find($id, $lockMode = null, $lockVersion = null)
 * @method JobInstance|null findOneBy(array $criteria, array $orderBy = null)
 * @method JobInstance[]    findAll()
 * @method JobInstance[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class JobInstanceRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, JobInstance::class);
    }

    public function add(JobInstance $entity, bool $flush = false): void
    {
    ...
    public function remove(JobInstance $entity, bool $flush = false): void
    {
